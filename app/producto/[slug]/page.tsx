  ...
  return (
    <>
      ...
      <div className={styles.product}>
        ...
        <div className={styles.gallery}>
          <div className={styles.mainImage} onClick={() => openLightbox(activeImg)}>
            ...
            />
            <button className={styles.zoomBtn} aria-label={t('Ampliar imagen', 'Zoom image')}>
        ...
        <div className={styles.info}>
          ...
          {/* Specs — Material, Dimensions, Made in only */}
          ...
          <button className={`btn btn-outline btn-full ${styles.wishlistBtn}`}>
      ...
      >
        ...
        <button className="lightbox-prev" onClick={() => lbNav(-1)}>‹</button>
        <button className="lightbox-next" onClick={() => lbNav(1)}>›</button>
      </div>
    </>
  )
}
