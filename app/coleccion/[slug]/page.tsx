...
const CATEGORY_MAP: Record<string, { name: { es: string; en: string }; desc: { es: string; en: string }; image: string }> = {
  'bolsos':        { name: { es: 'Bolsos', en: 'Bags' }, desc: { es: 'Bolsos artesanales hechos a mano en Tenerife.', en: 'Handmade artisan bags made in Tenerife.' }, image: '/img/categories/bolsos.jpg' },
  ...
  'edicion-arte':  { name: { es: 'Edición Arte', en: 'Art Edition' }, desc: { es: 'Piezas únicas inspiradas en obras de arte.', en: 'Unique pieces inspired by works of art.' }, image: '/img/categories/bolsos.jpg' },
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!cat) return {}
  return { title: `${cat.name.es} — NacaRam`, description: cat.desc.es }
}
