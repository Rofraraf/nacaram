  ...
  if (items.length === 0) return (
    <div className={styles.empty}>
      ...
      <p className="subtitle" style={{ marginBottom: '28px' }}>
        Your cart is empty · Explora nuestras piezas
      </p>
  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.inner}>
        ...
        <h1 className={`title-lg ${styles.title}`}>
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.summary}>
            ...
            <p className={styles.summaryNote}>
              Stripe Checkout se activará próximamente. Para comprar ahora escríbenos a{' '}
              <a href="mailto:info@nacaram.com">info@nacaram.com</a>
            </p>
            <button className="btn btn-dark btn-full" style={{ marginTop: '20px' }}>
              Proceder al pago
            </button>
